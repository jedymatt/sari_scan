...
void main() {
  ...
  group('Customer.copyWith', () {
    ...
    test('with no args preserves existing phone and deletedAt', () {
      final result = baseCustomer.copyWith();
      expect(result.phone, '0917');
      expect(result.deletedAt, DateTime(2026, 1, 1));
    });
    ...
    test('clearDeletedAt: true sets deletedAt to null', () {
      final result = baseCustomer.copyWith(clearDeletedAt: true);
      expect(result.phone, '0917');
